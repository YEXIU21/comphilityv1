...
export default {
  ...
  methods: {
    loadProduct() {
      ...
      this.product = {
        id: productId,
        name: 'AMD RYZEN 7 9800X3D AM5 D5 5.2ghz with Radeon Graphics processor',
        price: 33150.00,
        stock: 300,
        category: 'processor',
        images: [
          { url: 'https://via.placeholder.com/200', id: 1 },
          { url: 'https://via.placeholder.com/200', id: 2 },
          { url: 'https://via.placeholder.com/200', id: 3 }
        ],
        description: `The AMD Ryzen 7 9800X3D AM5 processor delivers exceptional speed with 8 cores, 16 threads, and a 5.2GHz boost clock. Featuring 3D V-Cache and integrated Radeon Graphics, it excels in gaming and productivity. With DDR5 and PCIe 5.0 support, it ensures lightning-fast performance and seamless multitasking.`,
        specifications: `Name - AMD Ryzen™ 7 9800X3D
Family - Ryzen
...
Default TDP - 120W`
    ...
    handleImageUpload(event) {
      ...
      for (let i = 0; i < files.length; i++) {
        if (this.product.images.length >= 4) break
